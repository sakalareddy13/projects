...
1. Install AWS CLI and run `aws configure` with Access Key ID and Secret Access Key.
2. Ensure IAM user has permissions for: `ec2:Describe*`, `rds:Describe*`, `s3:List*`, `lambda:List*`.
